...
import com.programming.nhatanh.lesson7.entity.Configs;
...
public class HinhTron extends HinhHoc {
    ...
    public HinhTron(double radius) {
        if(super.getShapeCount() < com.programming.nhatanh.lesson7.entity.Configs.SO_LUONG_HINH_TOI_DA) {
            super.increaseShapeCount();
            this.radius = radius;
        } else {
            throw new HinhHocException("Số lượng hình tối đa là: " + com.programming.nhatanh.lesson7.entity.Configs. SO_LUONG_HINH_TOI_DA);
        }
    }
