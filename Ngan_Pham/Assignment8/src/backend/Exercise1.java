...
public class Exercise1 {
    ...
    public void question1() {
        ...
        listStudents.add(new Student("Orm"));
        listStudents.add(new Student("Ling"));
        listStudents.add(new Student("Thor"));
        listStudents.add(new Student("Khuan"));
        listStudents.add(new Student("Hirono"));
        listStudents.add(new Student("Stick"));
    ...
    public void question3() {
        ...
        studentSet.add(new Student("Ethan"));
        studentSet.add(new Student("Orm"));
        studentSet.add(new Student("Ling"));
        studentSet.add(new Student("Thor"));
        studentSet.add(new Student("Labubu"));
