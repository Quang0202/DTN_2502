...
public class Exercise3 {
    ...
    public void question1(){
        StudentExercise3<Integer> student1 = new StudentExercise3<>(1, "Tuan");
        StudentExercise3<Float> student2 = new StudentExercise3<>(2.5f, "Khi");
        StudentExercise3<Double> student3 = new StudentExercise3<>(3.14, "Nai Xu");
    ...
    public void question2() {
        StudentExercise3<Integer> student = new StudentExercise3<>(101, "Hoang");
        print(student);
        print(4);
        print(4.0);
    }
