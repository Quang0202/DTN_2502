...
import testingsystem_asssignmen1.*;
...
public class Exercise1 {
    ...
    public static void question1() {
        ...
        // Tạo Account
        Account account1 = new Account(1, "phamanhtuan1", "tuan@gmail.com", "Pham Anh Tuan", department1, position1, LocalDateTime.now());
        Account account2 = new Account(2, "nguyenvana", "an@gmail.com", "Nguyen Van A", null, position1, LocalDateTime.now());
    ...
    public static void question5() {
        // Tạo nhóm 1
        Group group1 = new Group(1, "Java Fresher", null, LocalDateTime.now());

        // Tạo các Account
        Account account1 = new Account(1, "phamanhtuan1", "tuan@gmail.com", "Pham Anh Tuan", null, null, LocalDateTime.now());
        Account account2 = new Account(2, "nguyenvana", "an@gmail.com", "Nguyen Van A", null, null, LocalDateTime.now());
        Account account3 = new Account(3, "lethivanb", "vanb@gmail.com", "Le Thi Van B", null, null, LocalDateTime.now());
    ...
    public static void question8() {
        ...
        // Tạo Account
        Account account1 = new Account(1, "phamanhtuan1", "tuan@gmail.com", "Pham Anh Tuan", department1, null, LocalDateTime.now());
        Account account2 = new Account(2, "nguyenvana", "an@gmail.com", "Nguyen Van A", department2, null, LocalDateTime.now());
        Account account3 = new Account(3, "lethivanb", "vanb@gmail.com", "Le Thi Van B", department3, null, LocalDateTime.now());
        Account account4 = new Account(4, "tranvanc", "tranvc@gmail.com", "Tran Van C", null, null, LocalDateTime.now()); // Không có phòng ban
    ...
    public static void question10() {
        ...
        Account account1 = new Account(1, "NguyenVanA@gmail.com", "Nguyễn Văn A","ewufuhu",sale,null,null);
        Account account2 = new Account(2, "NguyenVanB@gmail.com", "Nguyễn Văn B", "fnewfwe",marketing,null,null);
    ...
    public static void question13() {
        // Tạo danh sách account
        Account[] accounts = {
                new Account(1, "nguyenvana", "NguyenVanA@gmail.com", "Nguyễn Văn A", null, null, null),
                new Account(2, "tranvanb", "TranVanB@gmail.com", "Trần Văn B", null, null, null),
                new Account(3, "lethic", "LeThiC@gmail.com", "Lê Thị C", null, null, null),
                new Account(4, "phamvand", "PhamVanD@gmail.com", "Phạm Văn D", null, null, null)
        };
    ...
    public static void question16() {
        ...
        Account account1 = new Account(1, "NguyenVanA@gmail.com", "Nguyễn Văn A", null, sale,null,null);
        Account account2 = new Account(2, "NguyenVanB@gmail.com", "Nguyễn Văn B", null,marketing,null,null);
