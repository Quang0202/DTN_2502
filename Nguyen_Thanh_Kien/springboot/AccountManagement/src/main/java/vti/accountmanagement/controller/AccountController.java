...
public class AccountController {
    ...
    @PostMapping("/create")
    public ResponseEntity<?> createAccount(@Valid @RequestBody AccountCreateRequest account){
        accountService.save(account);
        return ResponseEntity.ok("Account created");
    }

    @PostMapping("/update")
    public ResponseEntity<?> updateAccount(@Valid @RequestBody AccountUpdateRequest account){
